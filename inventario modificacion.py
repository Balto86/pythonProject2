...
#Añadido to dict para convertir un objeto Producto a un diccionario.
    def to_dict(self):
        return {
            'id': self.id,
            'nombre': self.nombre,
...
#Añadido from dict para crear un objeto Producto a partir de un diccionario.
    @classmethod
...
#Añadida funcionalidad para cargar y guardar el inventario desde y en un archivo JSON (inventario.json).
#Se gestionan excepciones comunes como FileNotFoundError y PermissionError al manejar archivos.
